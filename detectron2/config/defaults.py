...
_C.MODEL.CAMERA_HEAD.NUM_CONV = 4
...
_C.MODEL.CAMERA_HEAD.LOSS_CRITERION = "kl"
_C.MODEL.CAMERA_HEAD.PITCH_WEIGHT = 1.
_C.MODEL.CAMERA_HEAD.ROLL_WEIGHT = 1.
_C.MODEL.CAMERA_HEAD.VFOV_WEIGHT = 1.
...
_C.MODEL.POINT_NET.TEMPERATURE = 1.0
_C.MODEL.POINT_NET.DETACH = False
_C.MODEL.POINT_NET.REFINE_TEMPERATURE = 1.0
...
_C.SOLVER.TEST_IMS_PER_BATCH = 1
